            ...
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {featured.map((project, i) => (
                        <div
                            key={project.slug}
                            className="animate-fade-in-up-view"
                            ...
                            >
                                <div className="relative h-full rounded-2xl border border-white/8 bg-card overflow-hidden hover:border-primary/30 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 hover:-translate-y-1">
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background: `linear-gradient(to right, ${project.color}60, ${project.color}20)`,
                                        }}
                                    />
                                            ...
                                            {project.tags
                                                ...
                                                .map((tag) => (
                                                    <Badge
                                                        key={tag}
                                                        variant="secondary"
                                                        className="rounded-full text-xs px-2.5 bg-white/6 text-foreground/70 border-0"
                                                    >
                                                        {tag}
                                                    </Badge>
                                                ))}
