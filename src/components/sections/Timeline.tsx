                ...
                <div className="flex flex-col gap-0 md:hidden relative">
                    ...
                    {milestones.map((item, i) => (
                        <ScrollReveal key={i} delay={i * 80}>
                            <div className="relative flex items-start gap-5 pb-8 last:pb-0 pl-12">
                                {/* Dot */}
                        ...
                        {milestones.map((item, i) => {
                            ...
                            return (
                                <ScrollReveal key={i} delay={i * 100}>
                                    <div className={`relative flex items-center min-h-[110px]`}>
...
function MilestoneCard({
    ...
    return (
        <div className="group relative max-w-[220px]">
            ...
            />
            <div className="relative overflow-hidden rounded-2xl border border-border bg-card px-4 py-3.5 shadow-xl shadow-black/10 dark:shadow-black/30 hover:border-primary/30 hover:shadow-primary/10 transition-colors duration-300">
