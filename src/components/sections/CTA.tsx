    ...
    return (
        <section className="py-24" style={{ contentVisibility: 'auto', containIntrinsicSize: '0 400px' }}>
            <div className="container mx-auto px-4 max-w-5xl">
                <ScrollReveal>
                    <div className="relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/12 via-card to-card p-10 md:p-16 text-center">
                        ...
                        <div className="relative z-10 flex flex-col items-center gap-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 mt-2">
                                <Button
                                    ...
                                    nativeButton={false}
                                    render={
                                        <Link href="mailto:two-tech-dev@proton.me" />
                                    }
                                >
                                ...
                                <Button
                                    size="lg"
                                    variant="outline"
                                    className="h-12 px-8 rounded-xl text-base border-border hover:border-primary/40 hover:bg-primary/8 text-muted-foreground"
                                    nativeButton={false}
