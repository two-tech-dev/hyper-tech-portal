    ...
    <section className="py-24">
      <div className="container mx-auto px-4 max-w-5xl">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/12 via-card to-card p-10 md:p-16 text-center"
        >
          {/* Decorative glows */}
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            <p className="text-primary font-semibold text-sm tracking-[0.15em] uppercase">Ready to build?</p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-2">
              <Button
                ...
                render={<Link href="mailto:support@2tech.studio" />}
              >
